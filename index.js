import {
  ...
  function generate_loot() {
      ...
      for (let i=0; i<done; i++) {
          ...
          switch (id) {
              ...
              case 'g_weapon':
                  g_weapon = g_weapon + 1
                  console.log('Guthan weapon obtained')
              case 'k_head':
                  k_head = k_head + 1
              ...
              case 'k_weapon':
                  k_weapon = k_weapon + 1
                  console.log('Karil weapon obtained')
                  break
              case 't_head':
                  t_head = t_head + 1
              ...
              case 't_weapon':
                  t_weapon = t_weapon + 1
                  console.log('Torag weapon obtained')
                  break
              case 'v_head':
                  v_head = v_head + 1
              ...
              case 'v_weapon':
                  v_weapon = v_weapon + 1
                  console.log('Verac weapon obtained')
                  break
              case 'a_head':
                  a_head = a_head + 1
              ...
              case 'a_body':
                  a_body = a_body + 1
                  console.log('Ahrim body obtained')
                  break
              case 'a_legs':
                  a_legs = a_legs + 1
              ...
              case 'a_weapon':
                  a_weapon = a_weapon + 1
                  console.log('Ahrim weapon obtained')
                  break
          }
  ...
  function main() {
      ...
      for (let l=0; l<sims; l++){
          total_kc = total_kc + generate_loot() 
      }
